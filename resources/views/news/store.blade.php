    ...
    <div class="container">
        <div class="card" style="margin-top:10%; ">
            ...
            <div class="card-body col" style="padding: 5%;">
                ...
                @endif
                <form action="{{url('berita/proses-store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Judul Berita</label>
                        <input name="judul" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Isikan dengan judul berita" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">Konten Berita</label>
                        <textarea class="form-control ckeditor" id="ckeditor" name="konten" rows="3" placeholder="Isi dengan isi dan deskripsi berita" required></textarea>
                    </div>
                    <div class="mt-4">
